...
--
-- Table structure for table `productos_sabores`
--

DROP TABLE IF EXISTS `productos_sabores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `productos_sabores`
--

LOCK TABLES `productos_sabores` WRITE;
/*!40000 ALTER TABLE `productos_sabores` DISABLE KEYS */;
/*!40000 ALTER TABLE `productos_sabores` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping routines for database 'planet_cookie'
--
